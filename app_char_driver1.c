...
#define DEVICE_PATH "/dev/dev1"  // Path to the device file in /dev
#define BUFFER_SIZE 1024         // Buffer size for read/write operations
...
int main() {
    ...
    lseek(fd, 0, SEEK_SET);  // Reset offset to the beginning of the device
